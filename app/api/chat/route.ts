...
5. CÁLCULO DE PRECIO: Usa la fórmula: (Peso Total × $${PRICING.pricePerPound.toFixed(2)}) + (Costo de los artículos) + (Cargos de envío en SV). 
...
EJEMPLOS DE CÁLCULO:
- 1 caja de 2 libras: (2 × $${PRICING.pricePerPound.toFixed(2)}) = $13.98, pero mínimo es $${PRICING.minimumCharge.toFixed(2)} + cargos de envío en SV + costo de artículos (si aplica).
- 2 cajas de 5 libras cada una: Peso Total = 10 libras. (10 × $${PRICING.pricePerPound.toFixed(2)}) = $69.90 + cargos de envío en SV + costo de artículos (si aplica).
- 5 libras + 2 perfumes de $20 cada uno: (5 × $${PRICING.pricePerPound.toFixed(2)}) + ($20 × 2) = $34.95 + $40.00 = $74.95 + cargos de envío en SV.
